<!-- GO GREEN AUTONOMOUS SOLAR SYSTEMS
АВТОНОМНЫЕ СОЛНЕЧНЫЕ СИСТЕМЫ GO GREEN -->
                ...
                <div id="gallery">
                    <figure>
                        ...
                        <ul align="center" class="nospace clear">
                            ...
                            AGM аккумулятор 250AH емкость: 3.2 кВт/ч<br>
                            Электрические интерфейсы: 2x 230Volt 50Hz 2000W евророзетки<br>
                            1x 12 Volt 20A автомобильный разъем<br>
                            ...
                            4x150Вт монокристаллических солнечных модуля.<br>
                                ...
                                AGM аккумулятор 500AH емкость 6.4 кВт/ч<br>
                                Электрические интерфейсы: 2x 230Volt 50Hz 2000W евророзетки<br>
                                1x 12 Volt 20A автомобильный разъем<br>
                                2x 5 Volt USB 1,1 A and 2,1 A порты<br><br>
                            <b>Стоимость: 2499 €</b>
                            ...
                            Допустимое напряжение 1000 V<br>
                            Напряжение холостого хода Voc 21,3 V<br>
                            Рабочая температура от -40 Содо +80 Со<br>
                            Номинальная мощность Pmax: 150W ± 3%<br>
                            Номинальное напряжение Vmp: 17,42 V<br>
                            Номинальный ток Imp: 8,61 A<br>
                            Ток короткого замыкания Isc: 9,15<br>
                        </p></li>
                        </ul>
                        <ul align="center" class="nospace clear">
                            <li class="one_third first">
                            ...
                            Хорошее напряжение в диапазоне высоких токов<br>
                            Длительный срок службы 10 - 12 лет в соответствии с EUROBAT<br>
